...
impl SentechApi {
    pub fn create_still_image_filer(&self) -> Result<StillImageFilerHandle, _EStApiCError_t> {
        ...
        let err = unsafe { create_filer(EStFilerType_t_StFilerType_StillImage, &mut filer_ptr) };
        ...
        let get_still_image_filer = unsafe {
            (*(*self.stapi_table).IStStillImageFiler)
                .GetIStStillImageFiler
                .unwrap()
        };
        let err = unsafe { get_still_image_filer(&mut filer_ptr, &mut still_image_filer_ptr) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
    ...
    pub fn create_system(&self) -> Result<SystemHandle, _EStApiCError_t> {
        ...
        let err = unsafe {
            create_fn(
                _EStSystemVendor_t_StSystemVendor_Default,
                _EStInterfaceType_t_StInterfaceType_All,
                &mut handle,
            )
        };
...
impl SystemHandle {
    ...
    pub fn update_interface_list(&self) -> Result<bool, _EStApiCError_t> {
        let update_iface_list =
            unsafe { (*(*self.api_table).IStSystem).UpdateInterfaceList.unwrap() };
    ...
    pub fn get_interface(&self, index: usize) -> Result<InterfaceHandle, _EStApiCError_t> {
        //Index of the target interface from 0 to GetInterfaceCount()-1
    ...
    pub fn create_first_ist_device(
        &self,
        access_flag: DeviceAccess,
    ) -> Result<DeviceHandle, _EStApiCError_t> {
...
impl InterfaceHandle {
    ...
    pub fn get_interface_info(&self) -> Result<InterfaceInfoHandle, _EStApiCError_t> {
        ...
        let get_iface_info = unsafe {
            (*(*self.api_table).IStInterface)
                .GetIStInterfaceInfo
                .unwrap()
        };
    ...
    pub fn update_device_list(&self) -> Result<bool, _EStApiCError_t> {
        let update_dev_list =
            unsafe { (*(*self.api_table).IStInterface).UpdateDeviceList.unwrap() };
    ...
    pub fn get_ist_device_info(&self, index: usize) -> Result<DeviceInfoHandle, _EStApiCError_t> {
        ...
        let err =
            unsafe { get_dev_info(ptr::addr_of!(self.ptr) as *mut _, index, &mut dev_info_ptr) };
    ...
    pub fn device_available(
        ...
        index: usize,
        access_flag: DeviceAccess,
    ) -> Result<bool, _EStApiCError_t> {
        let mut available: bool8_t = 0;

        let get_dev_available =
            unsafe { (*(*self.api_table).IStInterface).IsDeviceAvailable.unwrap() };
...
impl InterfaceInfoHandle {
    ...
    pub fn get_interface_name(&self) -> Result<String, _EStApiCError_t> {
        let mut len: usize = 256;
        let mut buffer = vec![0u8; len];
        let get_iface_name = unsafe {
            (*(*self.api_table).IStInterfaceInfo)
                .GetDisplayNameA
                .unwrap()
        };
        let err = unsafe {
...
impl PortHandle {
    ...
    pub fn get_inode_map(
        &self,
        genapi_table: *mut GenApi_Functions_t,
    ) -> Result<INodeMapHandle, _EStApiCError_t> {
...
impl DeviceInfoHandle {
    ...
    pub fn get_dev_status(&self) -> Result<DeviceAccess, _EStApiCError_t> {
        ...
        DeviceAccess::from_repr(access_status).ok_or(_EStApiCError_t_StApiCError_OutOfRange)
    }
...
impl DataStreamHandle {
    pub fn start_event_acquisition(&self) -> Result<(), _EStApiCError_t> {
        let start_acq = unsafe {
            (*(*self.api_table).IStDataStream)
                .StartEventAcquisitionThread
                .unwrap()
        };
    ...
    pub fn get_datastream_info(&self) -> Result<DataStreamInfoHandle, _EStApiCError_t> {
        ...
        let get_ds_info = unsafe {
            (*(*self.api_table).IStDataStream)
                .GetIStDataStreamInfo
                .unwrap()
        };
    ...
    pub fn start_acquisition(
        &self,
        num_acquisitions: u64,
        acq_start_flag: u32,
    ) -> Result<(), _EStApiCError_t> {
...
impl DataStreamInfoHandle {
    ...
    pub fn get_payload_size(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_payload_size = unsafe {
            (*(*self.api_table).IStDataStreamInfo)
                .GetPayloadSize
                .unwrap()
        };
...
impl StreamBufferHandle {
    pub fn start_event_acquisition(&self) -> Result<(), _EStApiCError_t> {
        let start_acq = unsafe {
            (*(*self.api_table).IStStreamBuffer)
                .StartEventAcquisitionThread
                .unwrap()
        };
        let err = unsafe { start_acq(ptr::addr_of!(self.ptr) as *mut _) };
...
impl StreamBufferInfoHandle {
    pub fn get_timestamp(&self) -> Result<u64, _EStApiCError_t> {
        ...
        let get_timestamp = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .GetTimestamp
                .unwrap()
        };
    ...
    pub fn check_image_present(&self) -> Result<bool, _EStApiCError_t> {
        ...
        let check_image_present = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .IsImagePresent
                .unwrap()
        };
        let err =
            unsafe { check_image_present(ptr::addr_of!(self.ptr) as *mut _, &mut is_present) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(is_present != 0)
    ...
    pub fn get_payload_type(&self) -> Result<PayloadType, _EStApiCError_t> {
        ...
        PayloadType::from_repr(payload_type as u32).ok_or(_EStApiCError_t_StApiCError_OutOfRange)
    }

    pub fn get_pixel_format(&self) -> Result<u64, _EStApiCError_t> {
        let mut pixel_format: u64 = 0;
        let get_pixel_format = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .GetPixelFormat
                .unwrap()
        };
    ...
    pub fn delivered_image_height(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_delivered_image_height = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .GetDeliveredImageHeight
                .unwrap()
        };
        let err = unsafe {
            get_delivered_image_height(
                ptr::addr_of!(self.ptr) as *mut _,
                &mut delivered_image_height,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn delivered_chunk_payload_size(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_delivered_chunk_payload_size = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .GetDeliveredChunkPayloadSize
                .unwrap()
        };
        let err = unsafe {
            get_delivered_chunk_payload_size(
                ptr::addr_of!(self.ptr) as *mut _,
                &mut delivered_chunk_payload_size,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_pixel_endianness(&self) -> Result<i32, _EStApiCError_t> {
        ...
        let get_pixel_endianness = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .GetPixelEndianness
                .unwrap()
        };
        let err = unsafe {
            get_pixel_endianness(ptr::addr_of!(self.ptr) as *mut _, &mut pixel_endianness)
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
    ...
    pub fn check_data_larger_buffer(&self) -> Result<bool, _EStApiCError_t> {
        ...
        let check_larger_buffer = unsafe {
            (*(*self.api_table).IStStreamBufferInfo)
                .IsDataLargerThanBuffer
                .unwrap()
        };
...
impl ImageHandle {
    ...
    pub fn get_image_pixel_format(&self) -> Result<ImagePixelFormat, _EStApiCError_t> {
        ...
        let get_pixel_format =
            unsafe { (*(*self.api_table).IStImage).GetImagePixelFormat.unwrap() };
        let err = unsafe { get_pixel_format(ptr::addr_of!(self.ptr) as *mut _, &mut pixel_format) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        ImagePixelFormat::from_repr(pixel_format).ok_or(_EStApiCError_t_StApiCError_OutOfRange)
    }
    ...
    pub fn get_pixel_component_val(
        &self,
        x: usize,
        y: usize,
    ) -> Result<PixelComponentValueHandle, _EStApiCError_t> {
        let mut value_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_pixel_component_val = unsafe {
            (*(*self.api_table).IStImage)
                .GetIStPixelComponentValue
                .unwrap()
        };
        let err = unsafe {
            get_pixel_component_val(ptr::addr_of!(self.ptr) as *mut _, x, y, &mut value_ptr)
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
    ...
    pub fn set_image_clipboard(&self) -> Result<(), _EStApiCError_t> {
        let set_clipboard = unsafe {
            (*(*self.api_table).IStImage)
                .SetIStImageToClipboard
                .unwrap()
        };
...
impl ImageBufferHandle {
    pub fn create_image_buffer(
        &self,
        allocator: Option<PStApiHandle_t>,
    ) -> Result<ImageBufferHandle, _EStApiCError_t> {
        let allocator_handle = allocator.unwrap_or(ptr::null_mut());
        let mut image_buffer_handle: StApiHandle_t = unsafe { mem::zeroed() };
        let create_image_buffer = unsafe {
            (*(*self.api_table).IStImageBuffer)
                .CreateIStImageBuffer
                .unwrap()
        };
    ...
    pub fn copy_image(&self, image_handle: &ImageHandle) -> Result<(), _EStApiCError_t> {
        ...
        let err = unsafe {
            copy_image(
                ptr::addr_of!(self.ptr) as *mut _,
                ptr::addr_of!(image_handle.ptr) as *mut _,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
...
impl ImageAveragingFilterHandle {
    pub fn get_image_averaging_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<ImageAveragingFilterHandle, _EStApiCError_t> {
        let mut image_averaging_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStImageAveragingFilter)
                .GetIStImageAveragingFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut image_averaging_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_averaged_image(
        &self,
        image_buffer: ImageBufferHandle,
        component_bitcount: usize,
    ) -> Result<usize, _EStApiCError_t> {
        let get_averaged_image = unsafe {
            (*(*self.api_table).IStImageAveragingFilter)
                .GetAveragedImage
                .unwrap()
        };
        let err = unsafe {
            get_averaged_image(
                ptr::addr_of!(self.image_averaging_ptr) as *mut _,
                ptr::addr_of!(image_buffer.ptr) as *mut _,
                component_bitcount,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
...
impl PixelFormatInfoHandle {
    pub fn get_pixel_format_info(
        &self,
        pixel_format: ImagePixelFormat,
    ) -> Result<PixelFormatInfoHandle, _EStApiCError_t> {
        let mut pixel_format_info_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_pixel_format_info = unsafe {
            (*(*self.api_table).IStPixelFormatInfo)
                .GetIStPixelFormatInfo
                .unwrap()
        };
    ...
    pub fn get_pixel_format_name(&self) -> Result<String, _EStApiCError_t> {
        ...
        let get_pixel_format_name =
            unsafe { (*(*self.api_table).IStPixelFormatInfo).GetNameA.unwrap() };
        let err = unsafe {
            get_pixel_format_name(
                ptr::addr_of!(self.pixel_format_ptr) as *mut _,
                buffer.as_mut_ptr().cast(),
                &mut len,
            )
        };
    ...
    pub fn get_pixel_total_bitcount(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_bitcount = unsafe {
            (*(*self.api_table).IStPixelFormatInfo)
                .GetEachPixelTotalBitCount
                .unwrap()
        };
        let err = unsafe {
            get_bitcount(
    ...
    pub fn get_pixel_component_count(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_count = unsafe {
            (*(*self.api_table).IStPixelFormatInfo)
                .GetEachPixelTotalComponentCount
                .unwrap()
        };
    ...
    pub fn is_mono(&self) -> Result<u8, _EStApiCError_t> {
        ...
        let err =
            unsafe { get_is_mono(ptr::addr_of!(self.pixel_format_ptr) as *mut _, &mut is_mono) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(is_mono)
...
impl PixelComponentInfoHandle {
    pub fn get_pixel_component_info(
        &self,
        pixel_component: u32,
    ) -> Result<PixelComponentInfoHandle, _EStApiCError_t> {
        let mut component_info_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_component_info = unsafe {
            (*(*self.api_table).IStPixelComponentInfo)
                .GetIStPixelComponentInfo
                .unwrap()
        };
    ...
    pub fn get_value(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let err =
            unsafe { get_value(ptr::addr_of!(self.component_info_ptr) as *mut _, &mut value) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(value)
    ...
    pub fn get_name(&self) -> Result<String, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_name(
                ptr::addr_of!(self.component_info_ptr) as *mut _,
                buffer.as_mut_ptr().cast(),
                &mut len,
            )
        };
...
impl PixelComponentValueHandle {
    pub fn get_count(&self) -> Result<usize, _EStApiCError_t> {
        let mut count: usize = 0;
        let get_count = unsafe {
            (*(*self.api_table).IStPixelComponentValue)
                .GetCount
                .unwrap()
        };
    ...
    pub fn get_value(&self, index: usize) -> Result<i64, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_value(
                ptr::addr_of!(self.component_val_ptr) as *mut _,
                index,
                &mut value,
            )
        };
    ...
    pub fn get_pixel_component(&self, index: usize) -> Result<u32, _EStApiCError_t> {
        ...
        let get_component_index = unsafe {
            (*(*self.api_table).IStPixelComponentValue)
                .GetPixelComponent
                .unwrap()
        };
...
impl FeatureBagHandle {
    ...
    pub fn store_nodemap(
        &self,
        nodemap_handle: &INodeMapHandle,
        num_entries: i32,
    ) -> Result<i64, _EStApiCError_t> {
        let mut value: i64 = 0;
        let store_nodemap = unsafe {
            (*(*self.api_table).IStFeatureBag)
                .StoreNodeMapToBag
                .unwrap()
        };
        let err = unsafe {
            store_nodemap(
                ptr::addr_of!(self.feature_bag_ptr) as *mut _,
                ptr::addr_of!(nodemap_handle.nodemap_ptr) as *mut _,
                num_entries,
                &mut value,
            )
        };
...
impl FilterHandle {
    ...
    pub fn get_filter_info(&self) -> Result<FilterInfoHandle, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_filter_info(
                ptr::addr_of!(self.filter_ptr) as *mut _,
                &mut filter_info_handle,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_nodemap(
        ...
        let err =
            unsafe { get_nodemap(ptr::addr_of!(self.filter_ptr) as *mut _, &mut nodemap_ptr) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(INodeMapHandle {
...
impl FilterArrayHandle {
    pub fn filter(&self, count: usize) -> Result<ImageHandle, _EStApiCError_t> {
        ...
        let err = unsafe {
            filter(
                ptr::addr_of!(self.filter_array_ptr) as *mut _,
                count,
                &mut filter_array_ptr,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
...
impl FilterInfoHandle {
    pub fn get_filter_info(&self, filter_type: u32) -> Result<FilterInfoHandle, _EStApiCError_t> {
        let mut filter_info_handle: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter_info =
            unsafe { (*(*self.api_table).IStFilterInfo).GetIStFilterInfo.unwrap() };
    ...
    pub fn filter_type(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_filter_type(
                ptr::addr_of!(self.filter_info_ptr) as *mut _,
                &mut filter_type,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
...
impl GammaCorrectionFilterHandle {
    pub fn get_gamma_correction_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<GammaCorrectionFilterHandle, _EStApiCError_t> {
        let mut gamma_correction_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStGammaCorrectionFilter)
                .GetIStGammaCorrectionFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut gamma_correction_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_gamma_value(&self) -> Result<f64, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_gamma_value(
                ptr::addr_of!(self.gamma_correction_ptr) as *mut _,
                &mut gamma_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
...
impl ColorTransformationFilterHandle {
    pub fn get_color_transformation_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<ColorTransformationFilterHandle, _EStApiCError_t> {
        let mut color_transformation_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .GetIStColorTransformationFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut color_transformation_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_color_transformation_enable(&self) -> Result<u8, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_enable(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                &mut enabled,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn set_color_transformation_enable(&self, enable: u8) -> Result<(), _EStApiCError_t> {
        let set_enable = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .SetColorTransformationEnable
                .unwrap()
        };
        let err = unsafe {
            set_enable(
    ...
    pub fn get_color_transformation_value(
        &self,
        setting_type: u32,
    ) -> Result<f64, _EStApiCError_t> {
        let mut color_transformation_value: f64 = 0.0;
        let get_color_transformation_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .GetColorTransformationValue
                .unwrap()
        };
        let err = unsafe {
            get_color_transformation_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                setting_type,
                &mut color_transformation_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_color_transformation_value(
        &self,
        setting_type: u32,
        color_transformation_value: f64,
    ) -> Result<(), _EStApiCError_t> {
        let set_color_transformation_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .SetColorTransformationValue
                .unwrap()
        };
        let err = unsafe {
            set_color_transformation_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                setting_type,
                color_transformation_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_hue_correction_value(&self) -> Result<f64, _EStApiCError_t> {
        ...
        let get_hue_correction_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .GetHueCorrection
                .unwrap()
        };
        let err = unsafe {
            get_hue_correction_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                &mut hue_correction_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_hue_correction_value(
        &self,
        hue_correction_value: f64,
    ) -> Result<(), _EStApiCError_t> {
        let set_hue_correction_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .SetHueCorrection
                .unwrap()
        };
        let err = unsafe {
            set_hue_correction_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                hue_correction_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_saturation_correction_value(&self) -> Result<f64, _EStApiCError_t> {
        ...
        let get_saturation_correction_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .GetSaturationCorrection
                .unwrap()
        };
        let err = unsafe {
            get_saturation_correction_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                &mut saturation_correction_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_saturation_correction_value(
        &self,
        saturation_correction_value: f64,
    ) -> Result<(), _EStApiCError_t> {
        let set_saturation_correction_value = unsafe {
            (*(*self.api_table).IStColorTransformationFilter)
                .SetSaturationCorrection
                .unwrap()
        };
        let err = unsafe {
            set_saturation_correction_value(
                ptr::addr_of!(self.color_transformation_ptr) as *mut _,
                saturation_correction_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
...
impl EdgeEnhancementFilterHandle {
    pub fn get_edge_enhancement_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<EdgeEnhancementFilterHandle, _EStApiCError_t> {
        let mut edge_enhancement_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStEdgeEnhancementFilter)
                .GetIStEdgeEnhancementFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut edge_enhancement_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_strength(&self) -> Result<f64, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_strength(
                ptr::addr_of!(self.edge_enhancement_ptr) as *mut _,
                &mut strength,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn set_strength(&self, strength: f64) -> Result<(), _EStApiCError_t> {
        let set_strength = unsafe {
            (*(*self.api_table).IStEdgeEnhancementFilter)
                .SetStrength
                .unwrap()
        };
        let err =
            unsafe { set_strength(ptr::addr_of!(self.edge_enhancement_ptr) as *mut _, strength) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
...
impl BalanceRatioFilterHandle {
    pub fn get_balance_ratio_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<BalanceRatioFilterHandle, _EStApiCError_t> {
        let mut balance_ratio_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .GetIStBalanceRatioFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut balance_ratio_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_balance_ratio(&self, balance_selector: u32) -> Result<f64, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_balance_ratio(
                ptr::addr_of!(self.balance_ratio_ptr) as *mut _,
                balance_selector,
                &mut balance_ratio,
            )
        };
    ...
    pub fn set_balance_ratio(
        &self,
        balance_selector: u32,
        balance_ratio: f64,
    ) -> Result<(), _EStApiCError_t> {
        let set_balance_ratio = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .SetBalanceRatio
                .unwrap()
        };
    ...
    pub fn get_offset_before_gain(&self, balance_selector: u32) -> Result<i32, _EStApiCError_t> {
        ...
        let get_offset_before_gain = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .GetOffsetLevelBeforeGain
                .unwrap()
        };
        let err = unsafe {
            get_offset_before_gain(
                ptr::addr_of!(self.balance_ratio_ptr) as *mut _,
                balance_selector,
                &mut offset_before_gain,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_offset_before_gain(
        &self,
        balance_selector: u32,
        offset_before_gain: i32,
    ) -> Result<(), _EStApiCError_t> {
        let set_offset_before_gain = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .SetOffsetLevelBeforeGain
                .unwrap()
        };
        let err = unsafe {
            set_offset_before_gain(
                ptr::addr_of!(self.balance_ratio_ptr) as *mut _,
                balance_selector,
                offset_before_gain,
            )
    ...
    pub fn get_offset_after_gain(&self, balance_selector: u32) -> Result<i32, _EStApiCError_t> {
        ...
        let get_offset_after_gain = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .GetOffsetLevelAfterGain
                .unwrap()
        };
        let err = unsafe {
            get_offset_after_gain(
                ptr::addr_of!(self.balance_ratio_ptr) as *mut _,
                balance_selector,
                &mut offset_after_gain,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_offset_after_gain(
        &self,
        balance_selector: u32,
        offset_after_gain: i32,
    ) -> Result<(), _EStApiCError_t> {
        let set_offset_after_gain = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .SetOffsetLevelAfterGain
                .unwrap()
        };
        let err = unsafe {
            set_offset_after_gain(
                ptr::addr_of!(self.balance_ratio_ptr) as *mut _,
                balance_selector,
                offset_after_gain,
            )
    ...
    pub fn set_balance_white_auto(&self, white_auto: u32) -> Result<(), _EStApiCError_t> {
        let set_white_auto = unsafe {
            (*(*self.api_table).IStBalanceRatioFilter)
                .SetBalanceWhiteAuto
                .unwrap()
        };
        let err =
            unsafe { set_white_auto(ptr::addr_of!(self.balance_ratio_ptr) as *mut _, white_auto) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
...
pub enum NoiseReductionMode {
    ...
    SubtractingLightShieldingImage =
        EStNoiseReductionMode_t_StNoiseReductionMode_SubtractingLightShieldingImage,
...
impl NoiseReductionFilterHandle {
    pub fn get_noise_reduction_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<NoiseReductionFilterHandle, _EStApiCError_t> {
        let mut noise_reduction_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStNoiseReductionFilter)
                .GetIStNoiseReductionFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut noise_reduction_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_calibration_enabled(&self) -> Result<u8, _EStApiCError_t> {
        ...
        let get_calibration = unsafe {
            (*(*self.api_table).IStNoiseReductionFilter)
                .GetCalibrationEnable
                .unwrap()
        };
        let err = unsafe {
            get_calibration(
                ptr::addr_of!(self.noise_reduction_ptr) as *mut _,
                &mut calibration_enabled,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
...
impl FlatFieldCorrectionFilterHandle {
    pub fn get_flatfield_correction_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<FlatFieldCorrectionFilterHandle, _EStApiCError_t> {
        let mut flat_field_correction_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStFlatFieldCorrectionFilter)
                .GetIStFlatFieldCorrectionFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut flat_field_correction_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_flatfield_correction_mode(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let get_mode = unsafe {
            (*(*self.api_table).IStFlatFieldCorrectionFilter)
                .GetFlatFieldCorrectionMode
                .unwrap()
        };
        let err = unsafe {
            get_mode(
                ptr::addr_of!(self.flat_field_correction_ptr) as *mut _,
                &mut mode,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn get_calibration_target_value(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let get_target_value = unsafe {
            (*(*self.api_table).IStFlatFieldCorrectionFilter)
                .GetCalibrationTargetValue
                .unwrap()
        };
        let err = unsafe {
            get_target_value(
    ...
    pub fn set_calibration_target_value(&self, target_value: u32) -> Result<(), _EStApiCError_t> {
        let set_target_value = unsafe {
            (*(*self.api_table).IStFlatFieldCorrectionFilter)
                .SetCalibrationTargetValue
                .unwrap()
        };
        let err = unsafe {
            set_target_value(
...
pub enum ChromaSuppressionPartSelector {
    LowLuminancePart =
        EStChromaSuppressionPartSelector_t_StChromaSuppressionPartSelector_LowLuminancePart,
    HighLuminancePart =
        EStChromaSuppressionPartSelector_t_StChromaSuppressionPartSelector_HighLuminancePart,
...
impl ChromaSuppressionFilterHandle {
    pub fn get_chroma_suppression_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<ChromaSuppressionFilterHandle, _EStApiCError_t> {
        let mut chroma_suppression_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStChromaSuppressionFilter)
                .GetIStChromaSuppressionFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut chroma_suppression_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_threshold_value(&self, part_selector: u32) -> Result<u32, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_threshold(
                ptr::addr_of!(self.chroma_suppression_ptr) as *mut _,
                part_selector,
                &mut threshold,
            )
        };
    ...
    pub fn get_suppression_value(&self, part_selector: u32) -> Result<u32, _EStApiCError_t> {
        ...
        let get_suppression_value = unsafe {
            (*(*self.api_table).IStChromaSuppressionFilter)
                .GetSuppressionValue
                .unwrap()
        };
        let err = unsafe {
            get_suppression_value(
                ptr::addr_of!(self.chroma_suppression_ptr) as *mut _,
                part_selector,
                &mut suppression_value,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_suppression_value(
        &self,
        part_selector: u32,
        suppression_value: u32,
    ) -> Result<(), _EStApiCError_t> {
        let set_suppression_value = unsafe {
            (*(*self.api_table).IStChromaSuppressionFilter)
                .SetSuppressionValue
                .unwrap()
        };
        let err = unsafe {
            set_suppression_value(
                ptr::addr_of!(self.chroma_suppression_ptr) as *mut _,
                part_selector,
                suppression_value,
            )
...
impl SNMeasurementFilterHandle {
    pub fn get_sn_measurement_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<SNMeasurementFilterHandle, _EStApiCError_t> {
        let mut sn_measurement_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStSNMeasurementFilter)
                .GetIStSNMeasurementFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut sn_measurement_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn clear_grabbed_image(&self) -> Result<(), _EStApiCError_t> {
        let clear_grabbed_image = unsafe {
            (*(*self.api_table).IStSNMeasurementFilter)
                .ClearGrabbedImage
                .unwrap()
        };
        let err =
            unsafe { clear_grabbed_image(ptr::addr_of!(self.sn_measurement_filter_ptr) as *mut _) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
    ...
    pub fn get_frame_count(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_frame_count(
                ptr::addr_of!(self.sn_measurement_filter_ptr) as *mut _,
                &mut frame_count,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn retrieve_snmeasurement_result(
        &self,
        timeout: u32,
    ) -> Result<SNMeasurementResultHandle, _EStApiCError_t> {
        let mut measurement_result_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_result = unsafe {
            (*(*self.api_table).IStSNMeasurementFilter)
                .RetrieveIStSNMeasurementResult
                .unwrap()
        };
        let err = unsafe {
            get_result(
...
impl SNMeasurementResultHandle {
    pub fn get_component_count(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_component_count = unsafe {
            (*(*self.api_table).IStSNMeasurementResult)
                .GetComponentCount
                .unwrap()
        };
        let err = unsafe {
            get_component_count(
                ptr::addr_of!(self.sn_measurement_result_ptr) as *mut _,
                &mut component_count,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn get_snmeasurement_value(
        &self,
        component_index: usize,
    ) -> Result<(u32, usize, f64, f64, f64), _EStApiCError_t> {
...
impl DefectivePixelDetectionFilterHandle {
    pub fn get_defective_pixel_detection_filter(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<DefectivePixelDetectionFilterHandle, _EStApiCError_t> {
        let mut defective_pixel_detection_filter: StApiHandle_t = unsafe { mem::zeroed() };
        let get_filter = unsafe {
            (*(*self.api_table).IStDefectivePixelDetectionFilter)
                .GetIStDefectivePixelDetectionFilter
                .unwrap()
        };
        let err = unsafe {
            get_filter(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut defective_pixel_detection_filter,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn get_detection_result(
        &self,
        buffer_size: usize,
    ) -> Result<(u32, usize, Vec<_SStDefectivePixelInformation_t>), _EStApiCError_t> {
        let mut detection_status: u32 = 0;
        let mut defective_pixel_count: usize = buffer_size;
        let mut defective_pixel_list: Vec<_SStDefectivePixelInformation_t> =
            Vec::with_capacity(buffer_size);
        let get_detection_result = unsafe {
            (*(*self.api_table).IStDefectivePixelDetectionFilter)
                .GetDetectionResult
                .unwrap()
        };
        let err = unsafe {
            get_detection_result(
                ptr::addr_of!(self.defective_pixel_detection_ptr) as *mut _,
                &mut detection_status,
                &mut defective_pixel_count,
                defective_pixel_list.as_mut_ptr(),
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        ...
        Ok((
            detection_status,
            defective_pixel_count,
            defective_pixel_list,
        ))
    }

    pub fn clear_detection_result(&self) -> Result<(), _EStApiCError_t> {
        let clear_detection_result = unsafe {
            (*(*self.api_table).IStDefectivePixelDetectionFilter)
                .ClearDetectionResult
                .unwrap()
        };
        let err = unsafe {
            clear_detection_result(ptr::addr_of!(self.defective_pixel_detection_ptr) as *mut _)
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
...
pub enum StillImageFileFormat {
    // aug 20 note: important for saving img
...
impl FilerHandle {
    ...
    pub fn get_filer(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<FilerHandle, _EStApiCError_t> {
        let mut filer_ptr: StApiHandle_t = unsafe { mem::zeroed() };
    ...
    pub fn get_filer_info(&self) -> Result<FilerInfoHandle, _EStApiCError_t> {
        ...
        let err =
            unsafe { get_filer_info(ptr::addr_of!(self.filer_ptr) as *mut _, &mut filer_info_ptr) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(FilerInfoHandle {
...
impl FilerInfoHandle {
    pub fn get_filer_type(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let err = unsafe {
            get_filer_type(
                ptr::addr_of!(self.filer_info_ptr) as *mut _,
                &mut filer_type,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
...
impl StillImageFilerHandle {
    pub fn get_still_image_filer(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<StillImageFilerHandle, _EStApiCError_t> {
        let mut still_image_filer_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_still_image_filer = unsafe {
            (*(*self.api_table).IStStillImageFiler)
                .GetIStStillImageFiler
                .unwrap()
        };
        let err = unsafe {
            get_still_image_filer(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut still_image_filer_ptr,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn is_save_supported(
        &self,
        pixel_format: i32,
        image_file_format: u32,
    ) -> Result<u8, _EStApiCError_t> {
        let mut supported: u8 = 0;
        let is_save_supported = unsafe {
            (*(*self.api_table).IStStillImageFiler)
                .IsSaveSupported
                .unwrap()
        };
        let err = unsafe {
            is_save_supported(
                ptr::addr_of!(self.still_image_filer_ptr) as *mut _,
                pixel_format,
                image_file_format,
                &mut supported,
            )
    ...
    pub fn is_load_supported(
        &self,
        pixel_format: i32,
        image_file_format: u32,
    ) -> Result<u8, _EStApiCError_t> {
        let mut supported: u8 = 0;
        let is_load_supported = unsafe {
            (*(*self.api_table).IStStillImageFiler)
                .IsLoadSupported
                .unwrap()
        };
    ...
    pub fn save_image(
        ...
        let err = unsafe {
            save_image(
                ptr::addr_of!(self.still_image_filer_ptr) as *mut _,
                ptr::addr_of!(image_dat.ptr) as *mut _,
                image_file_format,
                file_name,
            )
        };
    ...
    pub fn set_quality(&self, quality: u32) -> Result<(), _EStApiCError_t> {
        ...
        let err =
            unsafe { set_quality(ptr::addr_of!(self.still_image_filer_ptr) as *mut _, quality) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
...
impl VideoFilerHandle {
    pub fn get_video_filer(
        &self,
        source_handle: InterfaceHandle,
    ) -> Result<VideoFilerHandle, _EStApiCError_t> {
        let mut video_filer_ptr: StApiHandle_t = unsafe { mem::zeroed() };
        let get_video_filer =
            unsafe { (*(*self.api_table).IStVideoFiler).GetIStVideoFiler.unwrap() };
        let err = unsafe {
            get_video_filer(
                ptr::addr_of!(source_handle.ptr) as *mut _,
                &mut video_filer_ptr,
    ...
    pub fn get_video_file_format(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let get_video_file_format = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .GetVideoFileFormat
                .unwrap()
        };
        let err = unsafe {
            get_video_file_format(
                ptr::addr_of!(self.video_filer_ptr) as *mut _,
                &mut video_file_format,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_video_file_format(&self, video_file_format: u32) -> Result<(), _EStApiCError_t> {
        let set_video_file_format = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .SetVideoFileFormat
                .unwrap()
        };
        let err = unsafe {
            set_video_file_format(
                ptr::addr_of!(self.video_filer_ptr) as *mut _,
                video_file_format,
            )
        };
    ...
    pub fn get_video_file_compression(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let get_video_file_compression = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .GetVideoFileCompression
                .unwrap()
        };
        let err = unsafe {
            get_video_file_compression(
                ptr::addr_of!(self.video_filer_ptr) as *mut _,
                &mut video_file_compression,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
    ...
    pub fn set_video_file_compression(
        &self,
        video_file_compression: u32,
    ) -> Result<(), _EStApiCError_t> {
        let set_video_file_compression = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .SetVideoFileCompression
                .unwrap()
        };
        let err = unsafe {
            set_video_file_compression(
                ptr::addr_of!(self.video_filer_ptr) as *mut _,
    ...
    pub fn get_quality(&self) -> Result<u32, _EStApiCError_t> {
        ...
        let err =
            unsafe { get_quality(ptr::addr_of!(self.video_filer_ptr) as *mut _, &mut quality) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(quality)
    ...
    pub fn set_reverse_y(&self, reverse_y: u8) -> Result<(), _EStApiCError_t> {
        ...
        let err =
            unsafe { set_reverse_y(ptr::addr_of!(self.video_filer_ptr) as *mut _, reverse_y) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
    ...
    pub fn register_filename(&self, file_name: *const i8) -> Result<(), _EStApiCError_t> {
        let register_filename = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .RegisterFileNameA
                .unwrap()
        };
        let err =
            unsafe { register_filename(ptr::addr_of!(self.video_filer_ptr) as *mut _, file_name) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
    ...
    pub fn register_image(
        &self,
        image_data: ImageHandle,
        frame_number: u32,
    ) -> Result<(), _EStApiCError_t> {
        let register_image =
            unsafe { (*(*self.api_table).IStVideoFiler).RegisterIStImage.unwrap() };
        let err = unsafe {
            register_image(
                ptr::addr_of!(self.video_filer_ptr) as *mut _,
                ptr::addr_of!(image_data.ptr) as *mut _,
                frame_number,
            )
        };
        if err != _EStApiCError_t_StApiCError_NoError {
    ...
    pub fn is_stopped(&self) -> Result<u8, _EStApiCError_t> {
        ...
        let err =
            unsafe { is_stopped(ptr::addr_of!(self.video_filer_ptr) as *mut _, &mut stopped) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(stopped)
    ...
    pub fn get_max_frame_count(&self) -> Result<usize, _EStApiCError_t> {
        ...
        let get_max_frame_count = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .GetMaximumFrameCountPerFile
                .unwrap()
        };
        let err = unsafe {
            get_max_frame_count(
    ...
    pub fn set_max_frame_count(&self, max_frame_count: usize) -> Result<(), _EStApiCError_t> {
        let set_max_frame_count = unsafe {
            (*(*self.api_table).IStVideoFiler)
                .SetMaximumFrameCountPerFile
                .unwrap()
        };
        let err = unsafe {
            set_max_frame_count(
...
impl INodeMapHandle {
    pub fn get_node(&self, name: &str) -> Result<INodeHandle, _EStApiCError_t> {
        ...
        let c_name = CString::new(name).map_err(|_| _EStApiCError_t_StApiCError_InvalidArgument)?; // <- verify this variant name exists

        let get_node = unsafe { (*(*self.api_table).INodeMap).GetNodeA.unwrap() };
        let err = unsafe {
            get_node(
                ptr::addr_of!(self.nodemap_ptr) as *mut _,
                c_name.as_ptr(),
                &mut node_ptr,
            )
        };
...
impl ValueHandle {
    pub fn to_string(
        &self,
        verify: bool8_t,
        ignore_cache: bool8_t,
    ) -> Result<String, _EStApiCError_t> {
        let mut len: usize = 256;
        let mut buffer = vec![0u8; len];
    ...
    pub fn from_string(&self, value: &str, verify: bool8_t) -> Result<(), _EStApiCError_t> {
        let c_value =
            CString::new(value).map_err(|_| _EStApiCError_t_StApiCError_InvalidArgument)?; // <- same variant as above
        let from_string = unsafe { (*(*self.api_table).IValue).FromStringA.unwrap() };
        let err =
            unsafe { from_string(ptr::addr_of!(self.ptr) as *mut _, c_value.as_ptr(), verify) };
        if err != _EStApiCError_t_StApiCError_NoError {
            return Err(err);
        }
        Ok(())
